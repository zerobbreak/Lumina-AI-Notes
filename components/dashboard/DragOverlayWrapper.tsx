        ...
        {isUploading && (
          ...
          >
            <div className="text-center">
              <div className="w-16 h-16 border-4 border-primary/30 border-t-indigo-500 rounded-full animate-spin mx-auto" />
              <p className="text-foreground/70 mt-6 text-lg">Uploading file...</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <AnimatePresence>
        {isDragActive && (
          ...
          >
            ...
            >
              <div className="w-24 h-24 bg-primary/20 rounded-3xl flex items-center justify-center mx-auto mb-6 border-4 border-dashed border-primary/50">
                <svg
