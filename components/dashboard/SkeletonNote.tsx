...
export const SkeletonNote = () => {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="w-full max-w-4xl mx-auto p-8 space-y-8 bg-muted/50 backdrop-blur-xl border border-border/60 rounded-3xl"
    >
      {/* Header */}
      <div className="flex flex-col space-y-4">
        <div className="h-12 w-3/4 bg-foreground/10 rounded-xl animate-pulse" />
        <div className="flex gap-3">
          <div className="h-6 w-24 bg-foreground/5 rounded-full animate-pulse" />
      ...
      <div className="space-y-6 pt-4">
        ...
        <div className="h-40 w-full bg-foreground/5 rounded-xl animate-pulse" />
