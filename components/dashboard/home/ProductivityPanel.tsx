    ...
    <section className={cn("min-w-0", className)}>
      <div className="flex items-center justify-between mb-3">
        ...
        <Button
          ...
          size="sm"
          onClick={onToggle}
          className="text-xs h-8 text-muted-foreground hover:text-foreground hover:bg-accent dark:hover:bg-foreground/5"
        >
      ...
      <div className="rounded-2xl border border-border bg-card shadow-sm ring-1 ring-black/5 dark:bg-inset dark:shadow-none dark:ring-0 overflow-hidden">
        {/* Reference-inspired hero header */}
        <div className="relative p-5">
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute -top-24 -left-24 h-56 w-56 rounded-full bg-primary/10 blur-3xl dark:bg-primary/15" />
          ...
          <div className="relative flex items-start justify-between gap-4">
            ...
            <div className="hidden sm:flex items-center justify-center h-11 w-11 rounded-2xl border border-border bg-muted/20 dark:bg-foreground/5">
        ...
        {showAnalytics ? (
          ...
          <div className="px-5 pb-5">
            <div className="rounded-xl border border-border bg-background/40 p-4 text-sm text-muted-foreground dark:bg-foreground/3">
